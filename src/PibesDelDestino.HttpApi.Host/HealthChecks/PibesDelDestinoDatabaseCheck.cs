...
public class PibesDelDestinoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public PibesDelDestinoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
