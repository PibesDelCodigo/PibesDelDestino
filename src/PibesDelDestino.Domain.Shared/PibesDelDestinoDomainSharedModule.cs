...
public class PibesDelDestinoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        PibesDelDestinoGlobalFeatureConfigurator.Configure();
        PibesDelDestinoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<PibesDelDestinoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<PibesDelDestinoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/PibesDelDestino");

            options.DefaultResourceType = typeof(PibesDelDestinoResource);
